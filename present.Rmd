...
<span style="font-size: 22x; text-decoration: underline;">3.Linear regression:</span>


```{r, echo = FALSE, message = FALSE}
knitr::kable(coefficents_dep_anx)

```

```{r, echo = FALSE, message = FALSE}
knitr::kable(coefficents_bipolar)

```

```{r, echo = FALSE, message = FALSE}
knitr::kable(coefficents_eating)

```

```{r, echo = FALSE, message = FALSE}
knitr::kable(cofficents_schizophrenia)

```

<span style="font-size: 22x; text-decoration: underline;">4.IDW:</span>
