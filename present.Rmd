---
title: "Does exposure to traffic-related noise pollution have an impact on mental health?"
author: "Tal Bracha"
date: "`r Sys.Date()`"
output:
...
<span style="font-size: 23px; text-decoration: underline;"> Literature Review Introduction:</span>
...
<span style="font-size: 22px; text-decoration: underline;">Data Description</span>.
...
The first test I made was the Shapiro-Wilk test, a statistical test used to evaluate the normality of a dataset, was the first test I ran to see if my data was normally distributed. The test determines if a sample of data is representative of a population that is normally distributed.
...
<span style="font-size: 28px; text-decoration: underline;">Statistical Analysis Results</span>
...
<span style="font-size: 28px; text-decoration: underline;">Mapping Results</span>
