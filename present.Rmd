...
1)Those were the results of my shapiro-wilk test:
...
This scatter plot shows the percentage of the population that experiences each mental health condition on the y axis and the percentage of the population that is exposed to noise on the x axis:

```{r, out.width = "900px",out.height = "500px",echo = FALSE}
knitr::include_graphics("mental_noise_scatter_plot.png")
