---
title: "GIT Seminar"
subtitle: "Exploring the Link Between Traffic Noise Pollution and Mental Well-being"
author: Tal Bracha
date: "September 2023"
...
setwd("C:/Users/talqq/Desktop/Geo-informatics Seminar/Seminar/Data")
library(dplyr)
library(knitr)
##Cleaning the data:
...
correlation_df_2 = stack(list("Depression" = correlation_depression_2, "Anxiety " = correlation_anxiety_2, "Eating Disorder" = correlation_eating_disorder_2, "Bipolar" = correlation_bipolar_2, "Schizophrenia" = correlation_schizophernia_2))
correlation_df_2 <- correlation_df_2[, c("ind", "values")]
colnames(correlation_df_2) = c("Mental Health Disorder", "Correlation Coefficient Value")

correlation_df_3 = stack(list("Depression" = correlation_depression_3, "Anxiety " = correlation_anxiety_3, "Eating Disorder" = correlation_eating_disorder_3, "Bipolar" = correlation_bipolar_3, "Schizophrenia" = correlation_schizophernia_3))
correlation_df_3 <- correlation_df_3[, c("ind", "values")]
colnames(correlation_df_3) = c("Mental Health Disorder", "Correlation Coefficient Value")

correlation_df_4 = stack(list("Depression" = correlation_depression_4, "Anxiety " = correlation_anxiety_4, "Eating Disorder" = correlation_eating_disorder_4, "Bipolar" = correlation_bipolar_4, "Schizophrenia" = correlation_schizophernia_4))
correlation_df_4 <- correlation_df_4[, c("ind", "values")]
colnames(correlation_df_4) = c("Mental Health Disorder", "Correlation Coefficient Value")
...
scatter_plot_2 <- ggplot(noise_mental_education_gini_Work, aes(x = `Gini Index`)) +
  geom_point(aes(y = `Depression %`, color = "Depression"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Schizophrenia %`, color = "Schizophrenia"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Anxiety %`, color = "Anxiety"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Bipolar Disorder %`, color = "Bipolar Disorder"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Eating Disorder %`, color = "Eating Disorder"), size = 2, alpha = 0.6) +
  labs(x = "Gini Index", y = "% of the population suffering from menatl disorder") +
  ggtitle("Mental Disorders vs. Gini Index") +
  theme_minimal() +
  scale_color_manual(values = c("blue", "red", "green", "black", "brown"),
                     labels = c("Depression", "Schizophrenia", "Anxiety", "Bipolar Disorder", "Eating Disorder"))

scatter_plot_with_trendlines_2 <- scatter_plot_2 +
  geom_smooth(aes(y = `Depression %`), method = "lm", color = "blue", se = FALSE) +
  geom_smooth(aes(y = `Schizophrenia %`), method = "lm", color = "red", se = FALSE) +
  geom_smooth(aes(y = `Anxiety %`), method = "lm", color = "green", se = FALSE) +
  geom_smooth(aes(y = `Bipolar Disorder %`), method = "lm", color = "black", se = FALSE) +
...
scatter_plot_3 <- ggplot(noise_mental_education_gini_Work, aes(x = `Avreage Years in School`)) +
  geom_point(aes(y = `Depression %`, color = "Depression"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Schizophrenia %`, color = "Schizophrenia"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Anxiety %`, color = "Anxiety"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Bipolar Disorder %`, color = "Bipolar Disorder"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Eating Disorder %`, color = "Eating Disorder"), size = 2, alpha = 0.6) +
  labs(x = "Avreage Years in School", y = "% of the population suffering from menatl disorder") +
  ggtitle("Mental Disorders vs. Avreage Years in School") +
  theme_minimal() +
  scale_color_manual(values = c("blue", "red", "green", "black", "brown"),
                     labels = c("Depression", "Schizophrenia", "Anxiety", "Bipolar Disorder", "Eating Disorder"))

scatter_plot_with_trendlines_3 <- scatter_plot_3 +
  geom_smooth(aes(y = `Depression %`), method = "lm", color = "blue", se = FALSE) +
  geom_smooth(aes(y = `Schizophrenia %`), method = "lm", color = "red", se = FALSE) +
  geom_smooth(aes(y = `Anxiety %`), method = "lm", color = "green", se = FALSE) +
  geom_smooth(aes(y = `Bipolar Disorder %`), method = "lm", color = "black", se = FALSE) +
...
scatter_plot_4 <- ggplot(noise_mental_education_gini_Work, aes(x = `Annual Working Hours`)) +
  geom_point(aes(y = `Depression %`, color = "Depression"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Schizophrenia %`, color = "Schizophrenia"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Anxiety %`, color = "Anxiety"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Bipolar Disorder %`, color = "Bipolar Disorder"), size = 2, alpha = 0.6) +
  geom_point(aes(y = `Eating Disorder %`, color = "Eating Disorder"), size = 2, alpha = 0.6) +
  labs(x = "Annual Working Hours", y = "% of the population suffering from menatl disorder") +
  ggtitle("Mental Disorders vs. Annual Working Hours") +
  theme_minimal() +
  scale_color_manual(values = c("blue", "red", "green", "black", "brown"),
                     labels = c("Depression", "Schizophrenia", "Anxiety", "Bipolar Disorder", "Eating Disorder"))

scatter_plot_with_trendlines_4 <- scatter_plot_4 +
  geom_smooth(aes(y = `Depression %`), method = "lm", color = "blue", se = FALSE) +
  geom_smooth(aes(y = `Schizophrenia %`), method = "lm", color = "red", se = FALSE) +
  geom_smooth(aes(y = `Anxiety %`), method = "lm", color = "green", se = FALSE) +
  geom_smooth(aes(y = `Bipolar Disorder %`), method = "lm", color = "black", se = FALSE) +
...
![](C:/Users/talqq/Desktop/logo.png)
</div>
...
This paper investigates the potential impact of exposure to traffic-related noise pollution on mental health, utilizing a multidisciplinary approach that combines statistical analysis, regression modeling and geospatial techniques. Data from 27 European countries were analyzed to assess the relationship between noise pollution exposure and the prevalence of various mental health disorders, including depression, anxiety, bipolar disorder, eating disorders, and schizophrenia. The study also explored the influence of socio-economic factors, such as the GINI Index, average years of schooling, and annual working hours, on mental health outcomes. The findings suggest that while some weak correlations exist between noise pollution exposure and specific mental health disorders, these associations do not imply causation. Geospatial analysis revealed hotspots of noise pollution in central and eastern Europe, which could guide future intervention strategies. Ultimately, this study underscores the complexity of the relationship between noise pollution and mental health, emphasizing the need for further research and policy interventions to better understand and address this issue.
...
This literature review dives into the connection between noise pollution and mental health. I will explore various studies and research to better understand how the noise around us can affect our mental state. From the noise regulations set by environmental agencies to the everyday hustle of city life, my aim is to uncover how noise pollution influences our mental health.

In addition, I'll look at papers that display how various socioeconomic indicators, including the Gini index, the average number of years spent in school, and long working hours, are affecting mental health.
...
<span style="font-size: 18px; text-decoration: underline;">Statistical Analysis:</span>

<b>*R was used for all of my statistical analysis.</b>

1)<b>Shapiro-Wilk test</b>:

The first test I made was the Shapiro-Wilk test, a statistical test used to evaluate the normality of a dataset. The test determines if a sample of data is representative of a population that is normally distributed.
...
It's crucial to remember that the Shapiro-Wilk test is sensitive to non-normality, particularly in the distribution's tails. Because of this, even little deviations from normalcy may result in the null hypothesis being rejected, especially with large sample numbers (Malato, 2023).
I also used histograms to visually analyze my data to see if it was normally distributed.

2)<b>Kendall's rank correlation coefficient test:</b>

The second test I conducted was the Kendall's rank correlation coefficient, which measures whether two variables are related or dependent on one another. It is frequently used to evaluate how comparable various data sets' ranks or ordering of observations are.
...
Since the size of differences between observations in ranked or ordinal data may not be well-defined, I chose Kendall's rank correlation coefficient over other tests. Due to its non-parametric nature and lack of assumptions regarding the underlying distribution of the data, it is effective when analyzing data that is not typically regarded with suspicion, such as some of my data. (Abdi, 2007)

3)<b>Linear regression model and multiple variable generalized linear regression:</b>


The third test I performed was a linear regression model and multiple variable generalized linear regression, which differs from regular linear regression model in being flexible and suitable for situations where the assumptions of ordinary linear regression, such as normality and constant variance of errors, may not hold.
...
The additional predictor factors I chose to include are supported by research that indicates they are connected to mental health issues. (Wong, 2020)


<span style="font-size: 18px; text-decoration: underline;">Mapping:</span>

<b>*ArcGIS Pro was used for all the mapping done in this paper.</b>

An essential component of my research involves mapping. I can find out more about the spatial distribution of noise pollution levels in Europe using the various ArcGIS Pro tools. I have the ability to locate regions with statistically significant clusters of high noise levels or determine if noise pollution is dispersed randomly or follows geographical patterns.
...
I then proceeded to create heat maps to better visualize my data. I produced heat maps based on polygons for all the information I gathered, including:
...
By using IDW I can learn more about the spatial distribution of noise pollution in Europe. By using this tool in ArcGIS pro I can convert vector shapefiles (in my case, polygons that were then converted to points) into raster images. In this manner, I can see the regions of Europe that are more impacted by noise pollution as opposed to the most polluted countries.


3)<b>Hot Spot Analysis:</b>

Another useful tool to evaluate the spatial distribution is the Hot Spot Analysis, This tool identifies statistically significant spatial clusters of high values (hot spots) and low values (cold spots) using Getis-Ord Gi statistic. It creates an Output Feature Class with a z-score, p-value, and confidence level bin field (Gi_Bin) for each feature in the Input Feature Class.
...
Dropping from 36 to 27 countries means that my hotspot analysis wasn't as accurate as it may have been since the recommendation is to have at least 30 input features.

And as I stated previously The percentage of the population exposed to various noise levels isn’t based on the entire population but rather only on people who live in cities with 100,000 or more residents, whereas the data on mental health is based on the entire population.
...
But when we look at the histograms, we see something a bit different:
...
Finally, I decided to rely only on the p-values to determine whether the data is distributed normally.
...
Depression, Anxiety, Eating Disorder and Bipolar show negative correlations, suggesting that higher levels of noise pollution exposure are weakly associated with slightly lower prevalence of these mental health disorders.
...
I also performed Kendall's test of correlation to determine whether there is a relationship between those mental health issues and the Gini Index, mean annual hours worked and the mean years of education.

<u>Gini Index:</u>

```{r, echo = FALSE, message = FALSE}
knitr::kable(correlation_df_2)
```

The Kendall's correlation coefficients between mental health disorders and the Gini index, which measures income inequality, reveal weak associations. Depression shows a weak positive correlation, indicating slightly higher rates in areas with greater income inequality. Anxiety exhibits a very weak negative correlation, suggesting a lack of substantial association. Meanwhile, eating disorders, bipolar disorder, and schizophrenia all demonstrate weak negative correlations, implying that higher income inequality might be weakly linked to slightly lower rates of these disorders.

<u>Avreage Annual Working Hours:</u>

```{r, echo = FALSE, message = FALSE}
knitr::kable(correlation_df_3)
```

The Kendall's correlation coefficients between mental health disorders and average annual working hours indicate mixed associations. Longer average annual working hours are moderately correlated with lower rates of anxiety, eating disorders, and bipolar disorder, suggesting that areas with extended work hours tend to have slightly fewer cases of these conditions. Additionally, schizophrenia exhibits a moderate positive correlation with longer working hours, suggesting slightly higher rates in areas with extended work hours. Notably, depression shows an almost negligible negative correlation, implying little to no relationship between depression rates and working hours.

<u>Mean Years of Education:</u>

```{r, echo = FALSE, message = FALSE}
knitr::kable(correlation_df_4)
```

The negative values for all the disorders suggest a weak negative association between the prevalence of these mental health conditions and the mean years of education. In other words, as the mean years of education increase, the prevalence of these mental health disorders tends to slightly decrease, though the relationships are quite weak.

It's crucial to emphasize that correlation does not imply causation. While these correlation coefficients provide insights into the associations between noise pollution exposure, gini index, avreage annual working hours, mean years of education and mental health disorders, they do not establish a causal relationship. Further research and analysis would be required to determine the underlying factors and mechanisms contributing to these associations.
In summary, the correlation coefficients suggest that there is a weak relationship between mental health disorders and the percentage of people exposed to noise pollution and the socioeconomic factor that I chose with specific disorders showing either weak negative or weak positive associations.
...
```{r,echo = FALSE, message = FALSE}
scatter_plot_with_trendlines_2
```

```{r,echo = FALSE, message = FALSE}
scatter_plot_with_trendlines_4
```

```{r,echo = FALSE, message = FALSE}
scatter_plot_with_trendlines_3
```

Those plots display the relationship between the percentage of the population exposed to noise pollution and the the socioeconomic variables I considered to the percentage of the population that is suffering from different mental disorders. Each colored point on the graph represents a specific mental disorder. Trendlines, represented by the straight lines, have been fitted to each set of points to show potential correlations.

Upon inspection, I can see that the anxiety trendline in the annual working hours plot unexpectedly decreases as more hours are worked, and the anxiety trendline in the mean years of education plot decreases as more years are spent in school.
Other than that, there is no overall upward or downward tendency to the trendiness across the conditions. This lack of consistency among the disorders shows that the socioeconomic variables I looked at for the prevalence of various mental disorders and noise exposure do not have a strong linear association.
...
* None of the predictor variables (noise exposure, Gini Index, average years in school, and annual working hours) show strong or statistically significant associations with depression.
* All p-values are relatively high, indicating weak evidence for their influence on depression.
...
* There is no clear or statistically significant association between any of the predictor variables and anxiety. 
* Only the variable "Annual Working Hours" shows a significant negative association with anxiety.
...
* None of the predictor variables show a strong or statistically significant association with Bipolar Disorder.
* All p-values are high, suggesting that these variables are not significant predictors.
...
* There is no clear or statistically significant link between any of the predictor variables and eating disorders.
* The fact that all p-values are large means that these factors are not reliable predictors.
...
* All of the predictor variables don't appear to have a strong or statistically significant relationship to schizophrenia.
* These variables may not be significant predictors, as indicated by the high p-values for all of them.

In conclusion, none of the mental health disorders I examined have substantial or statistically significant relationships between any of the predictor variables.
This shows that there may not be any association at all between these mental health issues and the selected predictors.


## Mapping Results

<span style="font-size: 22px; text-decoration: underline;">1.Heat Maps:</span>

All I had to do to create the heat map was divide my symbology into 8 classes and base it on graduated colors using natural breaks. Yellow denotes low noise pollution while red denotes high noise pollution in the color scheme I chose. 
This is the map that was produced:


```{r, echo = FALSE}
knitr::include_graphics("Noise.jpg")

```

Additionally, I produced heat maps for the Gini index, mean years of schooling, mean number of hours worked annually, and mental disorders. The appendices section contains those.

<span style="font-size: 22px; text-decoration: underline;">2.IDW:</span>

In order to perform the IDW on my map i had to convert my polygons to points, one for every country. After running IDW, the following map was produced:
...
By looking at the map I can see that similarly to the heat map above most of the noise pollution is concentrated mainly at the central part of Europe, the Baltic states and in south-eastern Europe (mainly Bulgaria).
While there are low concentrations of noise pollution in the Iberian Peninsula, the south of central Europe, the east of northern Europe, and the southeast of France.

<span style="font-size: 22px; text-decoration: underline;">3.Hot Spot Analysis:</span>

In order to perform the hot spot analysis, I had to select the polygon layer of the EU countries. As the input field, I chose the percentage of that nation's population exposed to noise pollution, as well as the kind of spatial relationship conceptualization, the "fixed distance band", which according to the ESRI website is best suited for the type of research I'm conducting. I received the following output map:

```{r,echo = FALSE}
knitr::include_graphics("Hot Spot Analysis.jpg")

```

I can determine with 95% certainty that the Slovakia-Hungary-Slovenia region is a noise pollution hot spot by looking at the output map. If I lower my confidence to 90%, I can also include Austria in this hotspot. Also identified as a hot zone with 90% confidence was Lithuania. There were no cold spots found.
...
This comprehensive study delves into the intricate relationship between exposure to traffic-related noise pollution and mental health, shedding light on a complex relationship that warrants further investigation. While my analysis reveals the presence of weak correlations between noise pollution exposure and specific mental health disorders, it is important to recognize that causation remains ambiguous. Several factors contribute to this complexity, including the small sample size, potential deviations from normality in my data, weak correlation coefficient and the absence of statistically significant linear regression associations. The modest sample size of 27 European countries imposes inherent limitations on the study's statistical power. 

The Shapiro-Wilks test initially suggested that some variables followed a normal distribution, as indicated by relatively high p-values. However, when visually inspecting histograms, we observed deviations from normality. This discrepancy underscores the sensitivity of normality tests to sample size, as smaller datasets may yield higher p-values, potentially masking non-normality. Therefore, my reliance solely on p-values for normality assessment may not offer a complete picture of data distribution. It underscores the importance of cautious interpretation when sample sizes are limited, and the visual examination of data distribution remains a valuable diagnostic tool.

The Kendall rank correlation tests suggested that there is a weak and diverse relationship between mental health disorders and the percentage of the population exposed to noise pollution. While some disorders show weak negative associations and one shows a weak positive association, the overall picture indicates that noise pollution exposure is not a strong predictor of the prevalence of these disorders. It is important to consider that mental health is influenced by a multitude of factors, including genetic, environmental, and societal.

Furthermore, the lack of significant linear regression associations between noise pollution and mental health disorders does not enhance the multifaceted nature of this relationship. None of the predictor variables, including noise exposure and socio-economic factors such as the GINI Index, average years of schooling, and annual working hours, demonstrated strong associations with mental health outcomes. This implies that the selected predictors may not provide reliable indicators of mental health in the context of noise pollution.

However, my geospatial analysis brought forth crucial insights. Hotspots of noise pollution were identified in central and eastern Europe, notably in regions surrounding Slovakia, Hungary, Slovenia, and Lithuania. These localized clusters of high noise pollution levels warrant special attention from policymakers and urban planners. The spatial distribution of noise pollution implies that interventions should be tailored to specific geographic areas to effectively mitigate its impact on mental health.

In summary, this study illuminates the intricate relationship between traffic-related noise pollution and mental health. While weak correlations are evident, causation remains elusive. The limitations posed by a modest sample size, potential deviations from normality, weak correlation coefficients and the absence of significant linear regression associations underscore the need for caution in drawing definitive conclusions. It becomes evident that further research is crucial to unraveling the nuances of this relationship. Policymakers and researchers must consider a holistic approach that accounts for multiple factors contributing to mental health outcomes. This research serves as a call to action for continued investigation and evidence-based policy decisions to address the impact of traffic-related noise pollution on mental health comprehensively.
...
```{r,echo = FALSE}
knitr::include_graphics("Depression.jpg")
...
```{r,echo = FALSE}
knitr::include_graphics("Anxiety.jpg")
...
```{r,echo=FALSE}
knitr::include_graphics("Eating Disorders.jpg")
...
```{r,echo = FALSE}
knitr::include_graphics("Bipolar.jpg")
...
```{r,echo = FALSE}
knitr::include_graphics("Schizophrenia.jpg")
...
```{r,echo = FALSE}
knitr::include_graphics("Gini.jpg")
...
```{r, echo = FALSE}
knitr::include_graphics("MYS.jpg")
...
```{r, echo = FALSE}
knitr::include_graphics("Annual Working Hours.jpg")
...
<span style="display: inline-block; margin-left: 40px;"> Retrieved September 26, 2023, from https://personal.utdallas.edu/~herve/Abdi-KendallCorrelation2007-pretty.pdf
 </span>

* Environmental Noise Directive. (n.d.). Environment. 

<span style="display: inline-block; margin-left: 40px;"> Retrieved September 26, 2023, from https://environment.ec.europa.eu/topics/noise/environmental-noise-directive_en
 </span>

* EPA identifies noise levels affecting health and welfare. US EPA. (1974). 

<span style="display: inline-block; margin-left: 40px;"> https://www.epa.gov/archive/epa/aboutepa/epa-identifies-noise-levels-affecting-health-and-welfare.html </span>


* Gini index. DataBank. (n.d.). 

<span style="display: inline-block; margin-left: 40px;"> https://databank.worldbank.org/metadataglossary/world-development-indicators/series/SI.POV.GINI </span>

* Jafari, M. J., Khosrowabadi, R., Khodakarim, S., & Mohammadian, F. (2019). The Effect of

<span style="display: inline-block; margin-left: 40px;">
Noise Exposure on Cognitive Performance and Brain Activity Patterns. Open Access Macedonian Journal of Medical Sciences, 7(17), 2924–2931. https://doi.org/10.3889/oamjms.2019.742
</span>

* Kondirolli, F., & Sunder, N. (2022). Mental health effects of education. Health Economics, 31(S2), 22–39. 

<span style="display: inline-block; margin-left: 40px;"> https://doi.org/10.1002/hec.4565 </span>

* Malato, G. (2023). An introduction to the Shapiro-Wilk test for normality. Built In. 

<span style="display: inline-block; margin-left: 40px;"> https://builtin.com/data-science/shapiro-wilk-test
</span>

* Noise pollution is still widespread across Europe, but there are ways to reduce the volume — 
<span style="display: inline-block; margin-left: 40px;">European Environment Agency. (n.d.). Www.eea.europa.eu. Retrieved September 28, 2023, from https://www.eea.europa.eu/signals-archived/signals-2020/articles/noise-pollution-is-still-widespread
</span>

* Orban, E., McDonald, K., Sutcliffe, R., Hoffmann, B., Fuks, K. B., Dragano, N., Viehmann, 

<span style="display: inline-block; margin-left: 40px;">
A., Erbel, R., Jöckel, K.-H., Pundt, N., & Moebus, S. (2016). Residential Road Traffic Noise and High Depressive Symptoms after Five Years of Follow-up: Results from the Heinz Nixdorf Recall Study. Environmental Health Perspectives, 124(5), 578–585. https://doi.org/10.1289/ehp.1409400
</span>

* Patel, V., Burns, J. K., Dhingra, M., Tarver, L., Kohrt, B. A., & Lund, C. (2018). Income inequality and depression: a 

<span style="display: inline-block; margin-left: 40px;"> systematic review and meta-analysis of the association and a scoping review of mechanisms. World Psychiatry, 17(1), 76–89. 
</span>

<span style="display: inline-block; margin-left: 40px;"> https://doi.org/10.1002/wps.20492
</span>

* Singh, D., Kumari, N., & Sharma, P. (2018). A review of adverse effects of road traffic noise on human health.  

<span style="display: inline-block; margin-left: 40px;"> Fluctuation and Noise Letters, 17(01), 1830001. </span>

<span style="display: inline-block; margin-left: 40px;"> https://doi.org/10.1142/s021947751830001x </span>


* Singh, N., & Davar, S. C. (2004). Noise Pollution-Sources, Effects and Control. Journal of Human Ecology, 16(3), 181–187. 

<span style="display: inline-block; margin-left: 40px;"> https://doi.org/10.1080/09709274.2004.11905735 </span>

* Tabraiz, S., Ahmad, S., Shehzadi, I., & Asif, M. B. (2015). Study of physio-psychological effects on traffic wardens due to 

<span style="display: inline-block; margin-left: 40px;"> traffic noise pollution; exposure-effect relation. Journal of Environmental Health Science & Engineering, 13(1). 
 </span>

<span style="display: inline-block; margin-left: 40px;">https://doi.org/10.1186/s40201-015-0187-x </span>

* Wong, J. (2020). Linear regression explained - towards data science. Medium. 

<span style="display: inline-block; margin-left: 40px;"> https://towardsdatascience.com/linear-regression-explained-1b36f97b7572
 </span>
